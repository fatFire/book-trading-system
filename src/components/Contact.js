  ...
  return (
    <Box height="80%" overflow="auto">
      {messages.map((message, index) => (
        <Message
          key={index}
          isLeft={message.fromto[0]?.id ? message.fromto[0].id !== user.id : message.fromto[0] !== user.id}
...
function SideBar({ conversations, setMessages, setConsersation }) {
  ...
  return (
    ...
    >
      <Text fontSize="24px" fontWeight="600" mb="10px" >Conversations: </Text>
